...
<!-- <script>
    ...
    var productLabels = {
        !!json_encode($data['product_labels']) !!
    };
    var productSales = {
        !!json_encode($data['product_sales']) !!
    };
    var productTargets = {
        !!json_encode($data['product_targets']) !!
    };
    var branchLabels = {
        !!json_encode($data['branch_labels']) !!
    };
    var branchSales = {
        !!json_encode($data['branch_sales']) !!
    };
    var branchTargets = {
        !!json_encode($data['branch_targets']) !!
    };
    var outstandingPrincipal = {
        !!json_encode($data['outstanding_principal']) !!
    };
    var PrincipalInArrears = {
        !!json_encode($data['principal_arrears']) !!
    };
    var totalTargets = {
        !!json_encode($data['total_targets']) !!
    };
    var totalSales = {
        !!json_encode($data['total_disbursements']) !!
    };
