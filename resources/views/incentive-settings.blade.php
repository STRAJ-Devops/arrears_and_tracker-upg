                        ...
                        <div class="card-header">
                            ...
                            <form action="{{ route('incentive-settings.store') }}" method="POST">
                                ...
                                <fieldset class="form-group border p-3">
                                    ...
                                    <div class="form-group row">
                                        <label for="min_par_individual" class="col-md-4 col-form-label text-md-right">Desired PAR (%)</label>
                                        <div class="col-md-6">
                                            <input type="text" name="min_par_individual" id="min_par_individual" class="form-control"
                                                value="0.00">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="max_par_individual" id="max_par_individual"
                                                value="{{ number_format($incentiveSettings->max_par_individual, 2, '.', ',') }}"
                                                class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="percentage_par_individual" class="col-md-4 col-form-label text-md-right">PAR Weight % Incentive</label>
                                        <div class="col-md-6">
                                            <input type="text" name="percentage_par_individual" id="percentage_par_individual" class="form-control"
                                                value="{{ number_format($incentiveSettings->percentage_par_individual ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                </fieldset>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="retention_min_individual" id="retention_min_individual" class="form-control"
                                                value="{{ number_format($incentiveSettings->retention_min_individual ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="retention_max_individual" id="retention_max_individual" class="form-control"
                                                value="{{ number_format($incentiveSettings->retention_max_individual ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="percentage_client_retention_individual" class="col-md-4 col-form-label text-md-right">Client Retention Weight % Incentive</label>
                                        <div class="col-md-6">
                                            <input type="text" name="percentage_client_retention_individual" id="percentage_client_retention_individual" class="form-control"
                                                value="{{ number_format($incentiveSettings->percentage_client_retention_individual ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset class="form-group border p-3">
                                    ...
                                    <div class="form-group row">
                                        <label for="min_net_portfolio_growth_individual" class="col-md-4 col-form-label text-md-right">Min Net Portfolio Growth</label>
                                        <div class="col-md-6">
                                            <input type="text" name="min_net_portfolio_growth_individual" id="min_net_portfolio_growth_individual" class="form-control"
                                                value="{{ number_format($incentiveSettings->min_net_portfolio_growth_individual ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="max_net_portfolio_growth_individual" class="col-md-4 col-form-label text-md-right">Max Net Portfolio Growth</label>
                                        <div class="col-md-6">
                                            <input type="text" name="max_net_portfolio_growth_individual" id="max_net_portfolio_growth_individual" class="form-control"
                                                value="{{ number_format($incentiveSettings->max_net_portfolio_growth_individual ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for=percentage_amount_growth_individual" class="col-md-4 col-form-label text-md-right">Portfolio Growth % Incentive</label>
                                        <div class="col-md-6">
                                            <input type="text" name="percentage_amount_growth_individual" id="percentage_amount_growth_individual" class="form-control"
                                                value="{{ number_format($incentiveSettings->percentage_amount_growth_individual ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset class="form-group border p-3">
                                    ...
                                    <div class="form-group row">
                                        <label for="percentage_client_growth_individual" class="col-md-4 col-form-label text-md-right">Portfolio Growth % Incentive</label>
                                        <div class="col-md-6">
                                            <input type="text" name="percentage_client_growth_individual" id="percentage_client_growth_individual" class="form-control"
                                                value="{{ number_format($incentiveSettings->percentage_client_growth_individual ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                </fieldset>
        ...
        <div class="tab-pane fade" id="groups" role="tabpanel" aria-labelledby="groups-tab" tabindex="0">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Group Settings</h4>
                            <form action="{{ route('incentive-settings.store') }}" method="POST">
                                @method('PATCH')
                                @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="max_par_group" id="max_par_group" class="form-control"
                                                value="{{ number_format($incentiveSettings->max_par_group ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="percentage_par_group" class="col-md-4 col-form-label text-md-right">PAR Weight % Incentive</label>
                                        <div class="col-md-6">
                                            <input type="text" name="percentage_par_group" id="percentage_par_group" class="form-control"
                                                value="{{ number_format($incentiveSettings->percentage_par_group ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                </fieldset>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="retention_min_group" id="retention_min_group" class="form-control"
                                                value="{{ number_format($incentiveSettings->retention_min_group ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="retention_max_group" id="retention_max_group" class="form-control"
                                                value="{{ number_format($incentiveSettings->retention_max_group ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="percentage_client_retention_group" class="col-md-4 col-form-label text-md-right">Client Retention Weight % Incentive</label>
                                        <div class="col-md-6">
                                            <input type="text" name="percentage_client_retention_group" id="percentage_client_retention_group" class="form-control"
                                                value="{{ number_format($incentiveSettings->percentage_client_retention_group ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset class="form-group border p-3">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="min_net_portfolio_growth_group" id="min_net_portfolio_growth_group" class="form-control"
                                                value="{{ number_format($incentiveSettings->min_net_portfolio_growth_group ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="max_net_portfolio_growth_group" id="max_net_portfolio_growth_group" class="form-control"
                                                value="{{ number_format($incentiveSettings->max_net_portfolio_growth_group ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="percentage_amount_growth_group" class="col-md-4 col-form-label text-md-right">Portfolio Growth % Incentive</label>
                                        <div class="col-md-6">
                                            <input type="text" name="percentage_amount_growth_group" id="percentage_amount_growth_group" class="form-control"
                                                value="{{ number_format($incentiveSettings->percentage_amount_growth_group ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset class="form-group border p-3">
                                    <legend>Portfolio Client Incentive</legend>
                                    <div class="form-group row">
                                        <label for="min_cap_client_group" class="col-md-4 col-form-label text-md-right">Min Net Client Growth</label>
                                        <div class="col-md-6">
                                            <input type="text" name="min_cap_client_group" id="min_cap_client_group" class="form-control"
                                                value="{{ number_format($incentiveSettings->min_cap_client_group ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="max_cap_client_group" class="col-md-4 col-form-label text-md-right">Max Net Client Growth</label>
                                        <div class="col-md-6">
                                            <input type="text" name="max_cap_client_group" id="max_cap_client_group" class="form-control"
                                                value="{{ number_format($incentiveSettings->max_cap_client_group ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="percentage_client_growth_group" class="col-md-4 col-form-label text-md-right">Portfolio Growth % Incentive</label>
                                        <div class="col-md-6">
                                            <input type="text" name="percentage_client_growth_group" id="percentage_client_growth_group" class="form-control"
                                                value="{{ number_format($incentiveSettings->percentage_client_growth_group ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                </fieldset>
        ...
        <div class="tab-pane fade" id="fast" role="tabpanel" aria-labelledby="fast-tab" tabindex="0">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Fast Settings</h4>
                            <form action="{{ route('incentive-settings.store') }}" method="POST">
                                @method('PATCH')
                                @csrf
                                ...
                                <div class="form-group row">
                                    <label for="max_llr_fast" class="col-md-4 col-form-label text-md-right">
                                        Maximum LLR (%)
                                    </label>
                                    <div class="col-md-6">
                                ...
                                <fieldset class="form-group border p-3">
                                    <legend>PAR Incentive</legend>
                                    <div class="form-group row">
                                        <label for="min_par_fast" class="col-md-4 col-form-label text-md-right">
                                            Desired PAR (%)
                                        </label>
                                        <div class="col-md-6">
                                            <input type="text" name="min_par_fast" id="min_par_fast" class="form-control"
                                                value="{{ number_format($incentiveSettings->min_par_fast ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="max_par_fast" class="col-md-4 col-form-label text-md-right">
                                            Max PAR %
                                        </label>
                                        <div class="col-md-6">
                                            <input type="text" name="max_par_fast" id="max_par_fast" class="form-control"
                                                value="{{ number_format($incentiveSettings->max_par_fast ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="percentage_par_fast" class="col-md-4 col-form-label text-md-right">
                                            PAR Weight % Incentive
                                        </label>
                                        <div class="col-md-6">
                                            <input type="text" name="percentage_par_fast" id="percentage_par_fast" class="form-control"
                                                value="{{ number_format($incentiveSettings->percentage_par_fast ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset class="form-group border p-3">
                                    <legend>Client Retention Incentive</legend>
                                    <div class="form-group row">
                                        <label for="retention_min_fast" class="col-md-4 col-form-label text-md-right">
                                            Min Client Retention (%)
                                        </label>
                                        <div class="col-md-6">
                                            <input type="text" name="retention_min_fast" id="retention_min_fast" class="form-control"
                                                value="{{ number_format($incentiveSettings->retention_min_fast ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="retention_max_fast" class="col-md-4 col-form-label text-md-right">
                                            Max Client Retention (%)
                                        </label>
                                        <div class="col-md-6">
                                            <input type="text" name="retention_max_fast" id="retention_max_fast" class="form-control"
                                                value="{{ number_format($incentiveSettings->retention_max_fast ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="percentage_client_retention_fast" class="col-md-4 col-form-label text-md-right">
                                            Client Retention Weight (%) Incentive
                                        </label>
                                        <div class="col-md-6">
                                            <input type="text" name="percentage_client_retention_fast" id="percentage_client_retention_fast" class="form-control"
                                                value="{{ number_format($incentiveSettings->percentage_client_retention_fast ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                </fieldset>
                        ...
                        <div class="card-header">
                            ...
                            <form action="{{ route('incentive-settings.store') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="max_llr_mse" id="max_llr_mse"
                                            value="{{ number_format($incentiveSettings->max_llr_mse, 2, '.', ',') }}"
                                            class="form-control" required>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="max_par_mse" id="max_par_mse" class="form-control"
                                                value="{{ number_format($incentiveSettings->max_par_mse ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="percentage_par_mse" class="col-md-4 col-form-label text-md-right">PAR Weight % Incentive</label>
                                        <div class="col-md-6">
                                            <input type="text" name="percentage_par_mse" id="percentage_par_mse" class="form-control"
                                                value="{{ number_format($incentiveSettings->percentage_par_mse ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                </fieldset>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="retention_min_mse" id="retention_min_mse" class="form-control"
                                                value="{{ number_format($incentiveSettings->retention_min_mse ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="retention_max_mse" id="retention_max_mse" class="form-control"
                                                value="{{ number_format($incentiveSettings->retention_max_mse ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="percentage_client_retention_mse" class="col-md-4 col-form-label text-md-right">Client Retention Weight % Incentive</label>
                                        <div class="col-md-6">
                                            <input type="text" name="percentage_client_retention_mse" id="percentage_client_retention_mse" class="form-control"
                                                value="{{ number_format($incentiveSettings->percentage_client_retention_mse ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                </fieldset>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="min_net_portfolio_growth_mse" id="min_net_portfolio_growth_mse" class="form-control"
                                                value="{{ number_format($incentiveSettings->min_net_portfolio_growth_mse ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="max_net_portfolio_growth_mse" id="max_net_portfolio_growth_mse" class="form-control"
                                                value="{{ number_format($incentiveSettings->max_net_portfolio_growth_mse ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="percentage_amount_growth_mse" class="col-md-4 col-form-label text-md-right">Portfolio Growth % Incentive</label>
                                        <div class="col-md-6">
                                            <input type="text" name="percentage_amount_growth_mse" id="percentage_amount_growth_mse" class="form-control"
                                                value="{{ number_format($incentiveSettings->percentage_amount_growth_mse ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset class="form-group border p-3">
                                    <legend>Portfolio Client Incentive</legend>
                                    <div class="form-group row">
                                        <label for="min_cap_client_mse" class="col-md-4 col-form-label text-md-right">Min Net Client Growth</label>
                                        <div class="col-md-6">
                                            <input type="text" name="min_cap_client_mse" id="min_cap_client_mse" class="form-control"
                                                value="{{ number_format($incentiveSettings->min_cap_client_mse ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="max_cap_client_mse" class="col-md-4 col-form-label text-md-right">Max Net Client Growth</label>
                                        <div class="col-md-6">
                                            <input type="text" name="max_cap_client_mse" id="max_cap_client_mse" class="form-control"
                                                value="{{ number_format($incentiveSettings->max_cap_client_mse ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="percentage_client_growth_mse" class="col-md-4 col-form-label text-md-right">Portfolio Growth % Incentive</label>
                                        <div class="col-md-6">
                                            <input type="text" name="percentage_client_growth_mse" id="percentage_client_growth_mse" class="form-control"
                                                value="{{ number_format($incentiveSettings->percentage_client_growth_mse ?? 0, 2, '.', ',') }}">
                                        </div>
                                    </div>
                                </fieldset>
