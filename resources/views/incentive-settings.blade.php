                            ...
                            ">Individual Settings</h4>
                                ...
                                <form action="{{ route('incentive-settings.store') }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="number" name="min_cap_client_individual" id="min_cap_client_individual" class="form-control"
                                    ...
                                    <div class="form-group row">
                                        <label for="max_par_individual" class="col-md-4 col-form-label text-md-right">Maximum
                                            PAR</label>
                                        <div class="col-md-6">
                                            <input type="number" name="max_par_individual" id="max_par_individual" class="form-control"
                            ...
                            ">Group Settings</h4>
                                ...
                                <form action="{{ route('incentive-settings.store') }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="number" name="min_cap_client_group" id="min_cap_client_group" class="form-control"
                                    ...
                                    <div class="form-group row">
                                        <label for="max_par_group" class="col-md-4 col-form-label text-md-right">Maximum
                                            PAR</label>
                                        <div class="col-md-6">
                                            <input type="number" name="max_par_group" id="max_par_group" class="form-control"
                                ...
                                <form action="{{ route('incentive-settings.store') }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        <label for="max_par_fast" class="col-md-4 col-form-label text-md-right">Maximum
                                            PAR</label>
                                        <div class="col-md-6">
                                            <input type="number" name="max_par_fast" id="max_par_fast" class="form-control"
