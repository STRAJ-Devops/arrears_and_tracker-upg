...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-1 " id="sidenav-main">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('tracker') ? 'active' : '') }}" href="{{ url('tracker') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-phone ps-2 pe-2 text-center text-dark {{ (Request::is('tracker') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('incentives') ? 'active' : '') }}" href="{{ url('incentives') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-gift ps-2 pe-2 text-center text-dark {{ (Request::is('incentives') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('regions') ? 'active' : '') }}" href="{{ url('regions') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-cogs ps-2 pe-2 text-center text-dark {{ (Request::is('regions') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('branches') ? 'active' : '') }}" href="{{ url('branches') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-cogs ps-2 pe-2 text-center text-dark {{ (Request::is('branches') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('user-management') ? 'active' : '') }}" href="{{ url('user-management') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-cogs ps-2 pe-2 text-center text-dark {{ (Request::is('user-management') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
            <span class="nav-link-text ms-1">User Management</span>
        </a>
      </li>
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('incentives-settings') ? 'active' : '') }}" href="{{ url('incentives-settings') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-cogs ps-2 pe-2 text-center text-dark {{ (Request::is('incentives-settings') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
            <span class="nav-link-text ms-1">Incentives</span>
        </a>
      </li>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('branch-targets-uploader') ? 'active' : '') }}" href="{{ url('branch-targets-uploader') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-upload ps-2 pe-2 text-center text-dark {{ (Request::is('branch-targets-uploader') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('product-targets-uploader') ? 'active' : '') }}" href="{{ url('product-targets-uploader') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
