<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-1 "
    id="sidenav-main">
    <div class="sidenav-header">
        <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none"
            aria-hidden="true" id="iconSidenav"></i>
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            <img src="{{ asset('assets/img/vfu_logo.png') }}" alt="vfu_logo" width="80%" height="80%"
                class="img-fluid">
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">General Section</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('arrears') ? 'active' : '' }} " href="{{ url('arrears') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Arrears</span>
                </a>
            </li>
            <li class="nav-item pb-2">
                <a class="nav-link {{ Request::is('tracker') ? 'active' : '' }}" href="{{ url('tracker') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Request::is('monitors') ? 'active' : '' }}" href="{{ url('monitors') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;"
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Request::is('group-details') ? 'active' : '' }}"
                    href="{{ url('group-details') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;"
                            class="fas fa-lg fa-address-book ps-2 pe-2 text-center text-dark {{ Request::is('group-details') ? 'text-white' : 'text-dark' }} "
                            aria-hidden="true"></i>
                    </div>
                    <span class="nav-link-text ms-1">Group Details</span>
                </a>
            </li>
            <li class="nav-item pb-2">
                <a class="nav-link {{ Request::is('expected-repayments') ? 'active' : '' }}"
                    ...
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;"
                            class="fas fa-lg fa-phone ps-2 pe-2 text-center text-dark {{ Request::is('expected-repayments') ? 'text-white' : 'text-dark' }} "
                            aria-hidden="true"></i>
                    </div>
            ...
            @if (Auth::user()->user_type == 5)
                <li class="nav-item pb-2">
                    <a class="nav-link {{ Request::is('show-all-comments') ? 'active' : '' }}"
                        href="{{ url('show-all-comments') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;"
                                class="fas fa-lg fa-comments ps-2 pe-2 text-center text-dark {{ Request::is('show-all-comments') ? 'text-white' : 'text-dark' }} "
                                aria-hidden="true"></i>
                        </div>
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Request::is('incentives') ? 'active' : '' }}" href="{{ url('incentives') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;"
                            class="fas fa-lg fa-gift ps-2 pe-2 text-center text-dark {{ Request::is('incentives') ? 'text-white' : 'text-dark' }} "
                            aria-hidden="true"></i>
                    </div>
                    <span class="nav-link-text ms-1">Incentives ({{ \Carbon\Carbon::now()->format('F Y') }})</span>
                </a>
            </li>
            <li class="nav-item pb-2">
                <a class="nav-link {{ Request::is('previous-incentives') ? 'active' : '' }}" href="{{ url('previous-incentives') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;"
                            class="fas fa-lg fa-gift ps-2 pe-2 text-center text-dark {{ Request::is('previous-incentives') ? 'text-white' : 'text-dark' }} "
                            aria-hidden="true"></i>
                    </div>
                    <span class="nav-link-text ms-1">Previous Incentives ({{ \Carbon\Carbon::now()->subMonth()->format('F Y') }})</span>
                </a>
            </li>
            <li class="nav-item pb-2">
            ...
            @if (Auth::user()->user_type == 5)
                ...
                <li class="nav-item pb-2">
                    <a class="nav-link {{ Request::is('regions') ? 'active' : '' }}" href="{{ url('regions') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;"
                                class="fas fa-lg fa-cogs ps-2 pe-2 text-center text-dark {{ Request::is('regions') ? 'text-white' : 'text-dark' }} "
                                aria-hidden="true"></i>
                        </div>
                ...
                <li class="nav-item pb-2">
                    <a class="nav-link {{ Request::is('branches') ? 'active' : '' }}" href="{{ url('branches') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;"
                                class="fas fa-lg fa-cogs ps-2 pe-2 text-center text-dark {{ Request::is('branches') ? 'text-white' : 'text-dark' }} "
                                aria-hidden="true"></i>
                        </div>
                ...
                <li class="nav-item pb-2">
                    <a class="nav-link {{ Request::is('user-management') ? 'active' : '' }}"
                        ...
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;"
                                class="fas fa-lg fa-cogs ps-2 pe-2 text-center text-dark {{ Request::is('user-management') ? 'text-white' : 'text-dark' }} "
                                aria-hidden="true"></i>
                        </div>
                ...
                <li class="nav-item pb-2">
                    <a class="nav-link {{ Request::is('roles') ? 'active' : '' }}" href="{{ url('roles') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;"
                                class="fas fa-lg fa-cogs ps-2 pe-2 text-center text-dark {{ Request::is('roles') ? 'text-white' : 'text-dark' }} "
                                aria-hidden="true"></i>
                        </div>
                ...
                <li class="nav-item pb-2">
                    <a class="nav-link {{ Request::is('incentives-settings') ? 'active' : '' }}"
                        href="{{ url('incentives-settings') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;"
                                class="fas fa-lg fa-cogs ps-2 pe-2 text-center text-dark {{ Request::is('incentives-settings') ? 'text-white' : 'text-dark' }} "
                                aria-hidden="true"></i>
                        </div>
                ...
                <li class="nav-item pb-2">
                    <a class="nav-link {{ Request::is('branch-targets-uploader') ? 'active' : '' }}"
                        href="{{ url('branch-targets-uploader') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;"
                                class="fas fa-lg fa-upload ps-2 pe-2 text-center text-dark {{ Request::is('branch-targets-uploader') ? 'text-white' : 'text-dark' }} "
                                aria-hidden="true"></i>
                        </div>
                        <span class="nav-link-text ms-1">Branch Targets</span>
                    </a>
                </li>

                <li class="nav-item pb-2">
                    <a class="nav-link {{ Request::is('product-targets-uploader') ? 'active' : '' }}"
                        href="{{ url('product-targets-uploader') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;"
                                class="fas fa-lg fa-upload ps-2 pe-2 text-center text-dark {{ Request::is('product-targets-uploader') ? 'text-white' : 'text-dark' }} "
                                aria-hidden="true"></i>
                        </div>
                ...
                <li class="nav-item pb-2">
                    <a class="nav-link {{ Request::is('previous-end-month-sales-uploader') ? 'active' : '' }}"
                        href="{{ url('previous-end-month-sales-uploader') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;"
                                class="fas fa-lg fa-upload ps-2 pe-2 text-center text-dark {{ Request::is('previous-end-month-sales-uploader') ? 'text-white' : 'text-dark' }} "
                                aria-hidden="true"></i>
                        </div>
