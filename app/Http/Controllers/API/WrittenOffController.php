...
class WrittenOffController extends Controller
{
    ...
    public function onlineWrittenOffDetails(Request $request)
    {
        ...
        try {
            $onlineRequest = \Illuminate\Support\Facades\Http::timeout(120)->get('https://ug.vft24.org/crmapi/v1/loan/wof/' . $searchCriteria . '/' . $searchPayload);
        } catch (\Throwable $th) {
