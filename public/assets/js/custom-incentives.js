                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-8">
                            <div class="card-body text-left">
                                ...
                                <p class="card-text"><strong> Number of ${incentivesDetails.incentive_type?.toLowerCase() === 'fast' ? 'Clients Checking' : 'Group'} (${incentivesDetails.incentive_type}):</strong> ${Number(incentivesDetails.unique_customer_id ?? 0).toLocaleString() ?? 0}</p>
